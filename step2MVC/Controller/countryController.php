...
require_once './Model/CountryRepository.php'; // Inclusion du fichier CountryRepository.php
require_once './Model/DetailsRepository.php'; // Inclusion du fichier DetailsRepository.php
...
function afficherPays()
{
    ...
    require './View/countriesView.php'; // Inclusion du fichier countriesView.php
}
...
function afficherDetailPays()
{
    ...
    require './View/countriesDetailsView.php'; // Inclusion du fichier countriesDetailsView.php
}
